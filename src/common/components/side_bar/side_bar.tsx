      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square">
          ...
          {!isCollapsed && (
            <Box mb="25px">
              <Box display="flex" justifyContent="center" alignItems="center">
                <img alt="profile-user" width="100px" height="100px" src={userImage} style={{ cursor: "pointer", borderRadius: "50%" }} />
              </Box>
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Item title="Yellow Pages" to="/vendors" icon={<ListOutlinedIcon />} selected={selected} setSelected={setSelected} />
          </Box>
        </Menu>
      </ProSidebar>
    </Box>
