...
export const CompanyDetails = forwardRef((props: any, ref: any) => {
  ...
  const { name, type, service, websiteURL, profile } =
    vendorDetails?.companyDetails;
    ...
    <React.Fragment>
      ...
      >
        <TextField
          ...
          helperText={
            errorMap.current.get("nameError")
        ...
        <TextField
          ...
          helperText={
            errorMap.current.get("typeError")
        ...
        <TextField
          ...
          helperText={
            errorMap.current.get("serviceError")
              ? "Company service details cannot be empty"
              : ""
          }
        />
        <TextField
